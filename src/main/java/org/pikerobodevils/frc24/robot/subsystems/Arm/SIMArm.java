...
import static org.pikerobodevils.frc24.robot.Constants.ArmConstants.ENCODER_ABS_DIO;
import static org.pikerobodevils.frc24.robot.Constants.ArmConstants.KA;
import static org.pikerobodevils.frc24.robot.Constants.ArmConstants.KD;
import static org.pikerobodevils.frc24.robot.Constants.ArmConstants.KG;
import static org.pikerobodevils.frc24.robot.Constants.ArmConstants.KI;
import static org.pikerobodevils.frc24.robot.Constants.ArmConstants.KP;
...
public void updatePositionController(){
    ...
    var feedforwardOutput = feedforward.calculate(MathUtil.angleModulus(arm.getAngleRads()), setpoint.velocity);
